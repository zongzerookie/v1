...
def main(argv):
    ...
    parser.add_argument('-p', '--pretrainingslist',
                        default=["checkpoints/tmc_dq_roberta_IR_e4.pth", "checkpoints/tmc_dq_roberta_NSP_e4.pth",
                                 "checkpoints/tmc_dq_roberta_NN_e4.pth", "checkpoints/dmc_dq_roberta_IR_e3.pth",
                                 "checkpoints/dmc_dq_roberta_NSP_e2.pth", "checkpoints/dmc_dq_roberta_NN_e4.pth"],
                        help='list of paths of the pretrainings model. They must be three. Default: checkpoints/tmc_dq_roberta_IR_e4.pth, checkpoints/tmc_dq_roberta_NSP_e4.pth, checkpoints/tmc_dq_roberta_NN_e2.pth, checkpoints/dmc_dq_roberta_IR_e3.pth, checkpoints/dmc_dq_roberta_NSP_e4.pth, checkpoints/dmc_dq_roberta_NN_e3.pth')
